sap.ui.define([
	...
	return BaseObject.extend("IP.ISYSTEM_PORTAL.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias Systemregi.System_Regi.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CustomerName, or by PartnerID
		 *
		...
		/**
		 * Groups by PartnerID, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
